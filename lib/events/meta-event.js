...
/**
 * Decode given buffer of MIDI data to a meta event
 *
 ...
 */
MetaEvent.decode = function (delay, status, buf) {
    var type, data = {}, length, value, rates = [24, 25, 30, 30];
...
MetaEvent.prototype.encode = function () {
    ...
    result = new MIDIBuffer(2 + vintLength(length) + length);
