...
MetaEvent._decodeInternal = function (buf, delay) {
    ...
    switch (type) {
    case MetaEvent.TYPE.SEQUENCE_NUMBER:
        data.number = buffer.readUIntBE(buf, 2);
        break;
    case MetaEvent.TYPE.TEXT:
    case MetaEvent.TYPE.COPYRIGHT_NOTICE:
    case MetaEvent.TYPE.SEQUENCE_NAME:
    ...
    case MetaEvent.TYPE.TIME_SIGNATURE:
        ...
        data.notated32ndsPerMIDIBeat = buffer.readUIntLE(buf, 1);
        break;
    case MetaEvent.TYPE.KEY_SIGNATURE:
...
MetaEvent.prototype._encodeInternal = function () {
    ...
    case MetaEvent.TYPE.SEQUENCE_NUMBER:
        ...
        buffer.writeUIntBE(buf, 2, this.data.number);
        break;
    case MetaEvent.TYPE.TEXT:
    case MetaEvent.TYPE.COPYRIGHT_NOTICE:
    case MetaEvent.TYPE.SEQUENCE_NAME:
    ...
    case MetaEvent.TYPE.TIME_SIGNATURE:
        ...
        buffer.writeUIntLE(buf, 1, this.data.notated32ndsPerMIDIBeat);
        break;
    case MetaEvent.TYPE.KEY_SIGNATURE:
        buf = new Buffer(2);
        buffer.start(buf);

        buffer.writeIntLE(buf, 1, this.data.note);
    ...
    length = varint.encode(buf.length);
