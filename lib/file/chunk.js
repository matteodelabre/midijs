...
/**
 * @overview Methods for decoding and encoding SMF chunks
 * that make up a Standard MIDI file, starting with
 * a header chunk (type = MThd), followed by one
 * or several track chunks (type = MTrk)
 */
