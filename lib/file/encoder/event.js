...
function encodeVarInt(value) {
    ...
    length = bytes.length;
    cursor = new BufferCursor(new Buffer(length));
...
function encodeMetaEvent(event) {
    ...
    case MetaEvent.TYPE.SEQUENCE_NUMBER:
        eventData = new BufferCursor(new Buffer(2));
    ...
    case MetaEvent.TYPE.END_OF_TRACK:
        eventData = new BufferCursor(new Buffer(0));
        break;
    case MetaEvent.TYPE.SET_TEMPO:
        eventData = new BufferCursor(new Buffer(3));
    ...
    case MetaEvent.TYPE.SMPTE_OFFSET:
        eventData = new BufferCursor(new Buffer(5));
    ...
    case MetaEvent.TYPE.TIME_SIGNATURE:
        eventData = new BufferCursor(new Buffer(4));
    ...
    case MetaEvent.TYPE.SEQUENCER_SPECIFIC:
        eventData = new BufferCursor(new Buffer(event.data.length));
    ...
    cursor = new BufferCursor(new Buffer(
