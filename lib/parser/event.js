...
function EventMeta(cursor) {
    var subtype, length, value, rates;
    ...
    case 84:
        ...
        this.rate = rates[value >> 6];
        this.hours = value & 0x3F;
        this.minutes = cursor.readUInt8();
        this.seconds = cursor.readUInt8();
        this.frames = cursor.readUInt8();
        this.subframes = cursor.readUInt8();
        break;
    case 88:
