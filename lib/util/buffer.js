...
/**
 * @prop {number} Maximal variable integer quantity
 */
MIDIBuffer.MAX_VAR_INT = 0x0FFFFFFF;
...
MIDIBuffer.getVarIntLength = function (value) {
    ...
    if (value > MIDIBuffer.MAX_VAR_INT) {
        return false;
    }
...
MIDIBuffer.prototype.writeVarInt = function (value) {
    ...
    if (value > MIDIBuffer.MAX_VAR_INT) {
        throw new Error('This number is too large for a variable integer');
    }
