 ...
 */
function useInt(buf, dir, signed, endian, bytes, value) {
 ...
 * @return {null}
 */
exports.writeUIntLE = function (buf, bytes, value) {
    return useInt(buf, 'write', 'U', 'LE', bytes, value);
};
 ...
 * @return {null}
 */
exports.writeUIntBE = function (buf, bytes, value) {
    return useInt(buf, 'write', 'U', 'BE', bytes, value);
};
 ...
 * @return {null}
 */
exports.writeIntLE = function (buf, bytes, value) {
    return useInt(buf, 'write', '', 'LE', bytes, value);
};
 ...
 * @return {null}
 */
exports.writeIntBE = function (buf, bytes, value) {
    return useInt(buf, 'write', '', 'BE', bytes, value);
};
 ...
 */
exports.write = function (buf, str, encoding) {
 ...
 * @return {number} Number of written bytes
 */
exports.copy = function (buf, src, start, end) {
 ...
 */
exports.readUIntLE = function (buf, bytes) {
    return useInt(buf, 'read', 'U', 'LE', bytes);
};
 ...
 * @return {number} Read value
 */
exports.readUIntBE = function (buf, bytes) {
    return useInt(buf, 'read', 'U', 'BE', bytes);
};
 ...
 * @return {number} Read value
 */
exports.readIntLE = function (buf, bytes) {
    return useInt(buf, 'read', '', 'LE', bytes);
};
 ...
 * @return {number} Read value
 */
exports.readIntBE = function (buf, bytes) {
    return useInt(buf, 'read', '', 'BE', bytes);
};
 ...
 */
exports.slice = function (buf, length) {
    var result = buf.slice(
        buf.cursor,
        (length === undefined) ? undefined : buf.cursor + length
    );
 ...
 * @param {bool} [noinc=false] Set to true to avoid incrementing the cursor
 */
exports.toString = function (buf, encoding, length) {
