...
test('events', function (sub) {
    sub.test('should encode and decode meta events', function (assert) {
    ...
    sub.test('should encode and decode sysex events', function (assert) {
        assert.ok(bufferEqual(
            new Buffer([0x00, 0xF0, 3, 0xa, 0xb, 0xc]),
            new SysexEvent('type 1', new Buffer([0xa, 0xb, 0xc])).encode()
    ...
    sub.test('should encode and decode channel events', function (assert) {
        assert.ok(bufferEqual(
